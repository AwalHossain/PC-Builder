...
export default function ProductCard({ product }) {
    ...
    return (
        ...
        <div className="relative">
          <Image src="https://images.pexels.com/photos/1714208/pexels-photo-1714208.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Shoes" width={500} height={500} />
        </div>
